	...
	public class SwitchConfig : MonoBehaviour
	{
		...
		void Update()
		{
			...
			if (state == 1)
			{
				...
				{
					switchRectTransform.anchoredPosition = Anim.Quint.SoftOut(new Vector2(currentSwitchPosition, 0f), new Vector2(20f, 0f), animDeltaTime, animationDuration);
				...
				{
					switchRectTransform.anchoredPosition = new Vector2(20f, 0f);
					switchImage.color = onColor;
					backImage.color = onColor;
